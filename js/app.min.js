...
$(function() {
	...
	(function () {
		...
		item.each(function(){
			...
			$(this).find('.progress__bar').css('width', countsItem + '%');
			$(this).find('.progress__bars').css('width', countsItem2 + '%');
	...
	$('.audio__volume').each(function() {
		var level = $(this).find('#volume').val();
		$('#volLevel').html(level+'%');
	});
	...
	// 	muteUmute = document.getElementById('muteUmute');


	// 	curTime = document.getElementById('currentTime');

	// 	emptyBar = document.getElementById('defaultBar');
	// 	progressBar = document.getElementById('progressBar');

	// 	volume = document.getElementById('volume');
	// 	volLevel = document.getElementById('volLevel');
	...
	// 	// Events Listener
	// 	playPause.addEventListener('click', playPauseSong, false);
	// 	muteUmute.addEventListener('click', muteUmuteSong, false);
	// 	progressBar.addEventListener('click', progressBarUpdate, false);
	// 	volume.addEventListener('click', setVolume, false);
	...
	// 		if (audio.paused) {
	// 			audio.play();
	// 			// playPause.style.backgroundImage = 'url("../img/audio/pause.png")';
	// 			updateTime = setInterval(update, 100);
	// 		} else {
	// 			audio.pause();
	// 			// playPause.style.backgroundImage = 'url("../img/audio/play.png")';
	// 			window.clearInterval(update);
	// 		}
	// 	}


	// 	// Mute and UnMute Song Function
	// 	function muteUmuteSong() {
	// 		if (!audio.muted) {
	// 			audio.muted = true;
	// 			// muteUmute.style.backgroundImage = 'url("../img/audio/mute.png")';			
	// 		} else {
	// 			audio.muted = false;
	// 			// muteUmute.style.backgroundImage = 'url("../img/audio/unmute.png")';
	// 		}
	// 	}

	// 	// Audio Track timer Calculation
	// 	mins = parseInt(audio.duration/60);
	// 	secs = parseInt(audio.duration%60);
	...
	// 	function update() {
	// 		if (!audio.ended) {
	// 			playedMins = parseInt(audio.currentTime/60);
	// 			playedSecs = parseInt(audio.currentTime%60);
	// 			curTime.innerHTML = playedMins+':'+playedSecs;
	...
	// 	function setVolume() {	
	// 		audio.volume = 0.1;		
	// 		var volumeLevel = audio.volume = volume.value/100;
	// 		volLevel.innerHTML = Math.round(volumeLevel*100) +'%';
	// 	}

	// }
	// window.addEventListener('load', audioPlayerApp);


	$('.lesson__progressbar-circle').each(function() {
		var level = $(this).find('input').val();
		$(this).find('.lesson__progressbar-level').html(level+'%');
		// console.log(level);
	});
	...
	// if (screen.width >= '980') {
	// 	$(".progress__info").hover(function() {
	// 	  $('.progress__hover').fadeIn(300);
	// 	}, function() {
	// 	  $('.progress__hover').fadeOut(500);
	// 	});

	// 	$(".progress__info2").hover(function() {
	// 	  $('.progress__hover2').fadeIn(300);
	// 	}, function() {
	// 	  $('.progress__hover2').fadeOut(500);
	// 	});
	// }

	$('.progress__infos').click(function() {
		$(this).find('sup').toggleClass('on');
		$('.progress__hovers').toggleClass('on');
	});
	...
	if (screen.width <= '768') {
		...
		$( document ).ready(function() {
			var UserSrc = $('.user__img').find('img').attr('src');
			$('.img-mm').attr('src', UserSrc);
			console.log(UserSrc);	
			var text = $('.user__title').text();
			// console.log(text);
			$('.mm-title').text(text);
		});
		...
		$("#my-menu").find("*").attr("style", " ").attr("class", " ");
		$("#my-menu").find("ul").removeClass("nav__list").addClass("mobile-mnu");
		$('.dropdown-menu').find("li").clone().appendTo(".mobile-mnu");
		...
		$("#my-menu").mmenu({
			...
			navbars: [{
				content: ['<img class="img-mm" src="img/profile-3-w.png" />'],
				height: 2
			}],
			counters: true,
			offCanvas: {
